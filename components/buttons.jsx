...
export const DefaultBtn = ({ buttonText, onClick, className }) => {
  return (
    <button
      type='button'
...
export const AlternativeBtn = ({ buttonText, onClick, className }) => {
  return (
    <button
      type='button'
...
export const RedBtn = ({ buttonText, onClick, className }) => {
  return (
    <button
      type='button'
...
export const WhiteBtn = ({ buttonText, onClick, className }) => {
  return (
    <button
      type='button'
